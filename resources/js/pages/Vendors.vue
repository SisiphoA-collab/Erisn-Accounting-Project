    ...
    <div class="py-2">
      ...
      <form @submit.prevent="fetchVendors" class="flex-grow-1">
        <div class="input-group">
          <input v-model="searchQuery" type="text" class="form-control" placeholder="Search by keyword..." />
         ...
         <!-- Vendor Table -->
          <table class="table table-striped">
            ...
            <tbody>
              <tr v-for="vendor in vendors?.data || []" :key="vendor.id">
                ...
                <td>
                  <button class="btn btn-sm btn-primary" @click="editVendor(vendor)">Edit</button>
          ...
          <!-- Pagination -->
          <Pagination v-if="vendors.links" :links="vendors.links" :fetchData="changePage" />
