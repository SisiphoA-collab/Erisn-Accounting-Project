...
<template>
  ...
  <!-- Invoices  -->
  <div>
    <h1 class="text-outline">Invoices</h1>
    <hr />
    ...
    <div class="d-flex flex-column flex-md-row mb-4">
      ...
      <form @submit.prevent="fetchInvoices" class="flex-grow-1">
        <div class="input-group">
          <input key="search" v-model="searchQuery" type="text" placeholder="Search invoices by customer name..."
      ...
      <tbody>
        <tr v-for="invoice in invoices?.data || []" :key="invoice.id">
          ...
          <td>
            ...
            <button class="btn btn-sm btn-primary ms-1" @click="editInvoice(invoice.id)">Edit</button>
            <button class="btn btn-sm btn-danger ms-1" @click="delInvoice(invoice)">Delete</button>
        ...
        <div class="modal-body">
          <form @submit.prevent="isEdit ? updateInvoice() : saveInvoice()">
            ...
            <div class="mb-3">
              ...
              <select class="form-select selectpicker" data-live-search="true" v-model="form.customer_id"
                :disabled="isEdit">
...
export default {
  ...
  setup() {
    ...
    return {
      invoices, currentPage, customers, statusOption, showModal, isEdit, links, delInvoice, columns,
      invoiceStats, form, searchQuery, statuses: ['All', ...statusOption], selectedStatus, message, messageType,
      updateSelected, fetchInvoices, changePage, addInvoice, editInvoice, saveInvoice, selectedInvoice, empty,
